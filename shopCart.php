...
<body>
    <a href="./customerList.php">Show Customers</a>
    ...
    <?php
    //using the provided files. Create a table, display the information of the selected user and calculate the total price of the user's shopping cart.
        class product{
            private $pName;
            private $price;
            private $qty;
