...
<body>
    ...
    <?php
        //Create a table using the given codes. In the table display the user information with previous desire.
        // The table headers should be:
        // FirstName, LastName, Previous Desire
        class dummyUser{
            private $fname;
            private $lname;
            private $desire;
        ...
        function readPrev($fileAddr){
            echo "<h1>Your previous desire wassss: </h1>";
        ...
        <tbody><tr>";
            while(!feof($fileHandler)){
                ...
                // echo "<td>".substr($string,strpos($string,":")+1)."</td>";
                echo "<td>".explode(":",$string)[1]."</td>";
            }
            echo "</tr>";
            fclose($fileHandler);
        }
