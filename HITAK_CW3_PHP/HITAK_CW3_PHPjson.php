...
<body> 
    ...
    <?php
        ...
        function loadData($employeeData){
            foreach($employeeData as $idx=>$employe){
            ...
            foreach($employeeData as $idx=>$employee){
                echo "<tr><td>$employee->EmployeeID</td><td>$employee->first_name</td><td>$employee->last_name</td><td>$employee->Department</td><td>$employee->Salary</td><td>$employee->email</td><td>$employee->Phone</td><td>$employee->Address</td><td><a href='./HITAK_CW3_PHP.php?idx=$idx'>Edit</a></td><td><a href='./HITAK_CW3_PHPjson.php?idx=$idx'>Delete</a></td></tr>";
            }
            echo "</table>";
        }
